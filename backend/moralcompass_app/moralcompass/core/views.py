...
class Home(TemplateView):
    ...
    def render_to_response(self, context, **kwargs):
		...
		for company in good_companies:
		    ...
		    stance = Stance.objects.create(organization=organization, cause=marriage, answer=1, reference='http://fake.com')
		    stance.save()

		response = super(Home, self).render_to_response(context, **kwargs)
