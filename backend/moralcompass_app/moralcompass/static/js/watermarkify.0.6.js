            ...
            return this.each(function() {
				...
				if(thisObj.val() != ""){
					if($.browser.msie){
						...
						thisObj.parent().find(".watermarkify-watermark-inner").css({"margin-left":"-100px","opacity":"0"});
					}
				}
				...
				thisObj.keyup(function(event){
					if($.browser.msie){
						...
						thisObj.parent().find(".watermarkify-watermark-inner").animate({"margin-left":"-100px","opacity":"0"},o.time1,o.easing);
					}
				});
